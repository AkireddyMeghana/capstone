...
public class EmployeeDaoImpl implements EmployeeDao{
	...
	private final String SQL_CREATE_EMPLOYEE = "insert into employeepro"
									+ "	(userId, firstName,lastName, dob, email, departId) "	
										+"values(?,?,?,?,?,? )";
	...
	public boolean  createEmployee(Employee employee) {
		// TODO Auto-generated method stub
		return jdbcTemplate.update(SQL_CREATE_EMPLOYEE, employee.getUserId(), employee.getFirstName(),employee.getLastName()
	...
	public boolean updateEmployee(Employee employee) {
		...
		return jdbcTemplate.update(SQL_UPDATE_EMPLOYEE,  employee.getFirstName(),employee.getLastName()
				,employee.getEmail(), employee.getDob(), employee.getDepartId()) > 0;
	}
